...
import {OrderItemsComponent} from './order/order-item/order-items.component';
...
@NgModule({
  ...
  providers: [RestaurantsService, ShoppingCartService, OrderService, FormBuilder, ControlContainer,
